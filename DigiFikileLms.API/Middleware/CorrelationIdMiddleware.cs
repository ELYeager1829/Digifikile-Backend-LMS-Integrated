/// <summary>
/// FILE: DigiFikileLms.API/Middleware/CorrelationIdMiddleware.cs
/// LAYER: API
///
/// WHAT THIS FILE IS:
...
///   Its immediate area is Correlation Id Middleware; read the individual type comments below before extending it.
///
/// WHY THIS LAYER:
...
/// PURPOSE: ASP.NET Core middleware responsible only for correlation id.
/// LMS ROLE: Supports the Correlation Id Middleware area while respecting the API layer boundary.
///
