...
/// <summary>
/// FILE: DigiFikileLms.API/Controllers/LessonsController.cs
/// LAYER: API
///
/// WHAT THIS FILE IS:
...
///   Its immediate area is Lessons; read the individual type comments below before extending it.
///
/// WHY THIS LAYER:
...
/// <summary>
/// TYPE: LessonsController
/// PURPOSE: The HTTP adapter for lessons endpoints.
/// LMS ROLE: Supports the Lessons area while respecting the API layer boundary.
///
...
public class LessonsController : ControllerBase
{
    ...
    /// </summary>
    [HttpPost]
    public async Task<IActionResult> Create(Guid moduleId, [FromBody] CreateLessonRequest request, CancellationToken ct) =>
        Ok(await _mediator.Send(new CreateLessonCommand(
            moduleId,
            request.Title,
            request.ContentType,
            request.OrderIndex,
            ...
            request.ContentUrl,
            request.ContentBody), ct));
}

/// <summary>
/// TYPE: CreateLessonRequest
/// PURPOSE: The api component responsible for create lesson request.
/// LMS ROLE: Supports the Lessons area while respecting the API layer boundary.
///
/// IMPLEMENTATION GUIDE:
