using DigiFikileLms.API.Middleware;


/// <summary>
/// FILE: DigiFikileLms.API/Extensions/ApplicationBuilderExtensions.cs
/// LAYER: API
///
/// WHAT THIS FILE IS:
...
///   Its immediate area is Application Builder Extensions; read the individual type comments below before extending it.
///
/// WHY THIS LAYER:
...
/// PURPOSE: The api component responsible for application builder extensions.
/// LMS ROLE: Supports the Application Builder Extensions area while respecting the API layer boundary.
///
...
{
    /// <summary>
    /// Executes the use digi fikile lms pipeline operation for this type. Keep the operation focused and preserve this layer's dependency boundary.
    /// </summary>
    public static WebApplication UseDigiFikileLmsPipeline(this WebApplication app)
    {
        ...
        if (app.Environment.IsDevelopment() || app.Environment.IsStaging())
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "DigiFikile LMS API v1");
                options.RoutePrefix = string.Empty;
            });
        }

        app.UseHttpsRedirection();
        app.UseCors("DigiFikileLmsCors");
