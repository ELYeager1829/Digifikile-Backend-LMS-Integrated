/// <summary>
/// FILE: DigiFikileLms.Domain/Enums/ProgressStatus.cs
/// LAYER: Domain
///
/// WHAT THIS FILE IS:
///   A framework-independent domain source file that defines the LMS's core vocabulary, state, rules, or persistence contracts.
///   Its immediate area is Progress Status; read the individual type comments below before extending it.
///
/// WHY THIS LAYER:
...
/// <summary>
/// TYPE: ProgressStatus
/// PURPOSE: The closed domain vocabulary for progress status.
/// LMS ROLE: Supports the Progress Status area while respecting the Domain layer boundary.
///
