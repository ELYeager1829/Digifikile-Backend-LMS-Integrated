        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComplainantUserId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Complaints_UserAccounts_ComplainantUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Complaints_ComplainantUserId_Status",
                table: "Complaints",
                columns: new[] { "ComplainantUserId", "Status" });
        }
