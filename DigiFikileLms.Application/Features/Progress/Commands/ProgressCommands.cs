...
/// <summary>
/// FILE: DigiFikileLms.Application/Features/Progress/Commands/ProgressCommands.cs
/// LAYER: Application
///
/// WHAT THIS FILE IS:
...
namespace DigiFikileLms.Application.Features.Progress.Commands;

/// <summary>
/// TYPE: UpdateProgressCommand
/// PURPOSE: An immutable CQRS write request for update progress.
...
public record UpdateProgressCommand(
    ...
    decimal Percentage,
    string Status
) : IRequest<BaseResponse<ProgressDto>>;

public record MarkModuleCompleteCommand(
    int StudentId,
    int ModuleId
) : IRequest<BaseResponse<bool>>;

public record MarkCourseCompleteCommand(
    int StudentId,
    int CourseId
) : IRequest<BaseResponse<bool>>;

/// <summary>
/// TYPE: UpdateProgressCommandHandler
/// PURPOSE: The MediatR handler that orchestrates the Update Progress Command use case.
/// LMS ROLE: Supports the Progress area while respecting the Application layer boundary.
///
/// IMPLEMENTATION GUIDE:
...
/// </summary>
public class UpdateProgressCommandHandler : IRequestHandler<UpdateProgressCommand, BaseResponse<ProgressDto>>
{
    /// <summary>
    ...
    /// </summary>
    public Task<BaseResponse<ProgressDto>> Handle(UpdateProgressCommand request, CancellationToken cancellationToken) =>
        throw new NotImplementedException("TODO: Upsert progress record via IProgressRepository.");
}
