...
/// <summary>
/// FILE: DigiFikileLms.Application/Features/Progress/Queries/ProgressQueries.cs
/// LAYER: Application
///
/// WHAT THIS FILE IS:
...
///   Its immediate area is Progress; read the individual type comments below before extending it.
///
/// WHY THIS LAYER:
...
namespace DigiFikileLms.Application.Features.Progress.Queries;

/// <summary>
/// TYPE: GetLearnerProgressQuery
/// PURPOSE: An immutable CQRS read request for get learner progress.
/// LMS ROLE: Supports the Progress area while respecting the Application layer boundary.
///
...
/// </summary>
public record GetLearnerProgressQuery(Guid UserId, Guid? CourseId = null) : IRequest<BaseResponse<IReadOnlyList<ProgressDto>>>;

//new
public record GetStudentProgressQuery(
    int StudentId
) : IRequest<BaseResponse<List<ProgressDto>>>;
...
/// <summary>
/// TYPE: GetLearnerProgressQueryHandler
/// PURPOSE: The MediatR handler that orchestrates the Get Learner Progress Query use case.
/// LMS ROLE: Supports the Progress area while respecting the Application layer boundary.
///
/// IMPLEMENTATION GUIDE:
...
//handler for GetLearnerProgressQuery

public class GetLearnerProgressQueryHandler : IRequestHandler<GetLearnerProgressQuery, BaseResponse<IReadOnlyList<ProgressDto>>>
{
    /// <summary>
    ...
    /// </summary>
    public Task<BaseResponse<IReadOnlyList<ProgressDto>>> Handle(GetLearnerProgressQuery request, CancellationToken cancellationToken) =>
        throw new NotImplementedException("TODO: Load learner progress records.");
}
