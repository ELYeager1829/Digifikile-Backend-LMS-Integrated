...
/// <summary>
/// FILE: DigiFikileLms.Application/Features/Roles/Commands/RoleCommands.cs
/// LAYER: Application
///
/// WHAT THIS FILE IS:
...
namespace DigiFikileLms.Application.Features.Roles.Commands;

/// <summary>
/// TYPE: CreateRoleCommand
/// PURPOSE: An immutable CQRS write request for create role.
...
/// </summary>
public record CreateRoleCommand(string Name, string Description) : IRequest<BaseResponse<RoleDto>>;
...
) : IRequest<BaseResponse<RoleDetailDto>>;
