/// <summary>
/// FILE: DigiFikileLms.Application/Interfaces/ICurrentUserService.cs
/// LAYER: Application
///
/// WHAT THIS FILE IS:
...
///   Its immediate area is I Current User Service; read the individual type comments below before extending it.
///
/// WHY THIS LAYER:
...
/// PURPOSE: An inward-facing abstraction for i current user service.
/// LMS ROLE: Supports the I Current User Service area while respecting the Application layer boundary.
///
